# FedFM  algorithm on Tensorflow

## Introduction

This code is the tensorflow version of FedFM algorithm. FedFM has an increase about 6%(from 66% to 72%) over traditional FedAVG algorithm in validation and testing accuracy on CIFAR10 dataset.
