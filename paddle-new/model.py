...
class ModelFedCon_noheader(nn.Layer):
    ...
    def __init__(self, base_model, out_dim, n_classes, net_configs=None):
        ...
        if base_model == "resnet50":
            ...
            basemodel.conv1 = paddle.nn.Conv2d(3, 64, kernel_size=3, stride=1, padding=1, bias=False)
            basemodel.maxpool = paddle.nn.Identity()
