# scene1
# fedfm  val acc:0.841847 , test acc:0.933500
# fedavg val acc:0.796961 , test acc:0.917600
import numpy as np
import json
import paddle
...
def get_args():
    ...
    parser.add_argument('--alg', type=str, default='fedfm',
                        help='communication strategy: fedfm')
...
if __name__ == '__main__':
    ...
    train_local_dls, val_local_dls, test_dl, net_dataidx_map, traindata_cls_counts, data_distributions = get_dataloader_new(args,logger)
